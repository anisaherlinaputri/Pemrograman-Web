...
if(!isset($_SESSION['login'])){
    ...
    <html lang="en">
        ...
        <body class="bg-secondary-subtle">
            <nav class="navbar navbar-expand-1g bg-body-tertiary shadow-sm">
                <div class="container">
    ...
    <main class="bg-white py-4 shadow-sm">
        ...
        <script
        src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY31HB60NNkmXc5s9fDVZLESAAA55NDz0xhy9GkcIds1K1eN7N6jIeHz" crossorigin="anonymous"></script>
    </body>
   </html>
  <?php
 }
